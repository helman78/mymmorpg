...
namespace GameServer.Services
{
    class UserService : Singleton<UserService>
    {
        ...
        public UserService()
        {
            ...
            MessageDistributer<NetConnection<NetSession>>.Instance.Subscribe<UserCreateCharacterRequest>(this.OnCreateChar);
        ...
        void OnLogin(NetConnection<NetSession> sender, UserLoginRequest request)
        {
            ...
            if (user != null)
            {
                ...
                else
                {
                    ...
                    message.Response.userLogin.Errormsg = "用户密码错误";
                }
            }
            else
            {
        ...
        void OnCreateChar(NetConnection<NetSession> sender, UserCreateCharacterRequest request)
        {
